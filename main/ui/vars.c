...
const char *get_var_time_txt()
{
    return time_txt;
}

void set_var_time_txt(const char *value)
{
    strncpy(time_txt, value, sizeof(time_txt) / sizeof(char));
    time_txt[sizeof(time_txt) / sizeof(char) - 1] = 0;
}

// 设置校准状态
char cali_status[100] = {0};

const char *get_var_cali_status()
{
    return cali_status;
}

void set_var_cali_status(const char *value)
{
